...
@section('content')
                ...
                <div class="col-12">
                    <div class="card shadow p-3">
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table table-hover" id="datatable">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Website</th>
    ...
    <div class="modal modal-blur fade show" id="modal-report" tabindex="-1" style="display: block;" aria-modal="true"
        role="dialog">
